...
This repo is functionality complete -- **Pull requests** and **Issues&** welcome!

Check out the [rails-5.1 branch](https://github.com/gothinkster/rails-realworld-example-app/tree/rails-5.1) to see the Latest code for **Rails 5.1**
